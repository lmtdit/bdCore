 ...
 * 服务端html模板构建和压缩模块
 */
var _, _buildHtml, _htmlMinify, _replaceImg, butil, color, common, config, errrHandler, fs, getJSONSync, gulp, gutil, include, minifyHTML, path, plumber;
