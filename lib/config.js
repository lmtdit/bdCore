...
module.exports = {
  ...
  GLOBALVAR: ("var STATIC_PATH='http://" + cndDomain + "/") + (cfg.evn === "local" ? srcPath : distPath) + ("',VARS=window['VARS']={},_VM_=window['_VM_']={},SiteUrl='" + SiteUrl + "',ApiUrl ='//" + WapSiteUrl + "/app',WapSiteUrl='//" + WapSiteUrl + "',AndroidSiteUrl='" + cfg.AndroidAppUrl + "',iosAppUrl='" + cfg.iosAppUrl + "',pagesize='" + cfg.pagesize + "';"),
  dataPath: './data',
