...
module.exports = {
  ...
  jsHash: 'jsHash.json',
  watchFiles: ['../' + srcPath + '/js/*.js', '../' + srcPath + '/js/**/*.js', '../' + srcPath + '/js/*.js', '../' + srcPath + '/sprite/**/*.png', '../' + srcPath + '/less/*.less', '../' + srcPath + '/less/**/*.less', '../' + srcPath + '/less/*.less', '../' + srcPath + '/tpl/**/*.html', '../' + srcPath + '/' + viewsDir + '*.html', '../' + srcPath + '/' + viewsDir + '**/*.html', '!../' + srcPath + '/**/.DS_Store']
};
