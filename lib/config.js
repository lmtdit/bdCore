 ...
 * @version $Id$
 */
var SiteUrl, WapSiteUrl, RealWapSiteUrl, _env, _envs, _isDebug, args, butil, cfg, cndDomain, distPath, path, ref, ref1, srcPath, st_root, viewsDir;
...
module.exports = {
  ...
  GLOBALVAR: ("var STATIC_PATH='http://" + cndDomain + "/") + (cfg.evn === "local" ? srcPath : distPath) + ("',VARS=window['VARS']={},_VM_=window['_VM_']={},SiteUrl='" + SiteUrl + "',ApiUrl ='//" + WapSiteUrl + "',WapSiteUrl='//" + WapSiteUrl + "',RealWapSiteUrl='//" + RealWapSiteUrl + "',AndroidSiteUrl='" + cfg.AndroidAppUrl + "',iosAppUrl='" + cfg.iosAppUrl + "',pagesize='" + cfg.pagesize + "';"),
  dataPath: './data',
  ...
  jsHash: 'jsHash.json',
  watchFiles: ['../' + srcPath + '/js/*.js', '../' + srcPath + '/js/**/*.js', '../' + srcPath + '/sprite/**/*.png', '../' + srcPath + '/less/*.less', '../' + srcPath + '/less/**/*.less', '../' + srcPath + '/tpl/**/*.html', '../' + srcPath + '/' + viewsDir + '*.html', '../' + srcPath + '/' + viewsDir + '**/*.html', '!../' + srcPath + '/**/.DS_Store']
};
