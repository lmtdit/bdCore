 ...
 * @version $Id$
 */
var _jsCtl, autowatch, binit, butil, color, config, cssToDist, cssbd, env, flctl, fs, gutil, htmlCtl, htmlToJs, isDebug, jsCtl, jsToDev, path, phpCtl;
...
exports.files = {
  ...
  delDistFiles: (function(_this) {
    return function() {
      ...
      return exports.files.delDistSpImg();
    };
  })(this)
};
