 ...
 * @author yy
 */
var Buffer, _, _hashFile, _jsLibs, _jsLibsFile, _oldHash, butil, config, e, exports, fs, md5, path;
...
exports = {
  ...
  checkHash: function(id, source) {
    var _flag, _md5, _name;
    _md5 = md5(source);
    _name = id + '.js';
    _flag = false;
    if (this._hash[id] && this._hash[id] === _md5 && _jsLibs[_name]) {
      _flag = true;
    } else {
      this._hash[id] = _md5;
    }
