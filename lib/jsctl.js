 ...
 * @version $Id$
 */
var GLOBALVAR, _, _buildJs, _buildJsDistMap, _updateJsDistMap, amdclean, butil, color, config, cssBgMap, e, errrHandler, filterDepMap, fs, gulp, gutil, jsDepBuilder, jsDistMapName, jsHash, jsImgRegex, jsToDist, md5, path, plumber, revall, rjs, rootPath, tryEval, uglify,
