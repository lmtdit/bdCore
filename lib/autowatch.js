 ...
 * @version $Id$
 */
var JSHINT, _autowatch, binit, butil, checkFile, color, config, css2dist, cssbd, errrHandler, fs, gutil, htmlCtl, htmlToJs, jsError, jshint, jsto, path, phpCtl, watch, watchChecker,
...
checkFile = (function(superClass) {
  ...
  checkFile.prototype.html = function(cb) {
    ...
    return htmlCtl(function() {});
  };

  checkFile.prototype.php = function(cb) {
    var _type;
    _type = this.type();
    if (_type !== 'php') {
      return false;
    }
    return phpCtl(function() {});
  };
  ...
  checkFile.prototype.build = function(cb) {
    var __html, __js, __less, __php, __sp, __tpl, _type;
    _type = this.type();
    __js = this.js;
    __tpl = this.tpl;
    __html = this.html;
